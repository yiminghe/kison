...
Generate time: Wed Oct 27 2021 11:44:12 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_ProcedureCall_37_group_3?',
          'eCS_ProcedureCall_37_group_8?',
        ],
      ],
      ['implicitCallStmt_InBlock', ['iCS_B_ProcedureCall']],
      [
        'iCS_B_ProcedureCall',
        ['IDENTIFIER', 'argsCall?', 'iCS_B_ProcedureCall_39_group_2?'],
      ],
      ['argsCall', ['argsCall_40_group_0*', 'argCall', 'argsCall_40_group_7*']],
      ['argsCall', ['argsCall_41_group_0*', 'argCall', 'argsCall_41_group_7*']],
      ['argsCall', ['argsCall_42_group_0*', 'argCall', 'argsCall_42_group_7*']],
      ['argsCall', ['argsCall_43_group_0*', 'argCall', 'argsCall_43_group_7*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_51_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_52_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['subscripts', ['subscript_', 'subscripts_53_group_1*']],
      ['subscript_', ['subscript__54_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_55_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      [
        ...
        [
          ...
          'RPAREN',
          'dictionaryCallStmt?',
          'iCS_S_ProcedureOrArrayCall_60_group_6?',
        ],
      ],
      [
        ...
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_61_group_3?',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__75_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_85_group_1?']],
      ...
      ['eCS_ProcedureCall_37_group_3', ['LPAREN', 'argsCall', 'RPAREN']],
      ['eCS_ProcedureCall_37_group_8', ['LPAREN', 'subscripts', 'RPAREN']],
      ['iCS_B_ProcedureCall_39_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_40_group_0', ['argCall?', ',']],
      ['argsCall_40_group_7', [',', 'argCall?']],
      ['argsCall_41_group_0', ['argCall?', ',']],
      ['argsCall_41_group_7', [';', 'argCall?']],
      ['argsCall_42_group_0', ['argCall?', ';']],
      ['argsCall_42_group_7', [',', 'argCall?']],
      ['argsCall_43_group_0', ['argCall?', ';']],
      ['argsCall_43_group_7', [';', 'argCall?']],
      ['variableListStmt_51_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_52_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscripts_53_group_1', [',', 'subscript_']],
      ['subscript__54_group_0', ['valueStmt', 'TO']],
      ['argList_55_group_1', ['arg', 'argList_55_group_1_193_group_1*']],
      [
        'iCS_S_ProcedureOrArrayCall_60_group_6',
      ...
      ['arg_71_group_7', ['LPAREN', 'RPAREN']],
      ['arg_72_group_7', ['LPAREN', 'RPAREN']],
      ['type__75_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_85_group_1', ['MULT', 'valueStmt']],
      ['argList_55_group_1_193_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
