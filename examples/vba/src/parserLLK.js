...
Generate time: Sat Oct 30 2021 01:46:18 GMT+0800 (中国标准时间)
*/
var vbaParser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ['argsCall', ['argCall?', 'argsCall_49_group_1*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_57_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_58_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['indexes', ['valueStmt', 'eraseStmt_28_group_2*']],
      ['subscript_', ['subscript__60_group_0?', 'valueStmt']],
      ['subscripts', ['subscript_', 'subscripts_61_group_1*']],
      ['subscript_', ['subscript__60_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_63_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      ['type_', ['baseType', 'arg_86_group_7?']],
      ['type_', ['complexType', 'arg_86_group_7?']],
      ['complexType', ['IDENTIFIER', 'complexType_92_group_1*']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_103_group_1?']],
      ...
      ['eCS_MemberProcedureCall_43_group_10', ['LPAREN', 'indexes', 'RPAREN']],
      ['iCS_B_ProcedureCall_48_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_49_group_1', [',', 'argCall?']],
      ['variableListStmt_57_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_58_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscript__60_group_0', ['valueStmt', 'TO']],
      ['subscripts_61_group_1', [',', 'subscript_']],
      ['argList_63_group_1', ['arg', 'argList_63_group_1_224_group_1*']],
      ['arg_86_group_7', ['LPAREN', 'RPAREN']],
      ['complexType_92_group_1', ['.', 'IDENTIFIER']],
      ['complexType_93_group_1', ['!', 'IDENTIFIER']],
      ['baseType_103_group_1', ['MULT', 'valueStmt']],
      ['argList_63_group_1_224_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
  ...
  var getNextReachableStateItems = function (
    ...
    newReachableStates = newReachableStates.filter((n) => !!n); // let current = newReachableStates[0];
    // if (current) {
    //   let i = 1;
