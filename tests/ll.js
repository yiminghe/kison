...
Generate time: Sat Oct 09 2021 14:09:29 GMT+0800 (中国标准时间)
*/
var $parser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ['$START', ['program']],
      ['program', ['statements']],
      ['(zeroMore_statement_1)1_', ['statement', '(zeroMore_statement_1)1_']],
      ['(zeroMore_statement_1)1_', []],
      ['zeroMore_statement_1', ['(zeroMore_statement_1)1_']],
      ['statements', ['statement', 'zeroMore_statement_1']],
  ...
  const productionSkipAstNodeSet = new Set([
    2, 3, 4, 6, 9, 10, 11, 13, 14, 15, 17, 18,
  ]);
