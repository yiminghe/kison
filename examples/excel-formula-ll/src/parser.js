...
Generate time: Thu Aug 19 2021 15:40:10 GMT+0800 (中国标准时间)
*/
var parser = (function(undefined) {
  ...
  parser.parse = function parse(input, options) {
    ...
    function getError() {
      ...
      const tips = [];
      if (expected.length) {
        tips.push("Expected tokens: " + expected.join(", "));
      }
      if (currentToken) {
