...
/*
Generated By kison v0.4.4

Generate time: Tue Jun 29 2021 17:24:36 GMT+0800 (中国标准时间)
*/
...
var lexer = new Lexer({
  rules: [
    ...
    {
      regexp: /^(?:(?:(?:'(?:''|[^'])*')|(?:(?:[_A-Za-z]+[_A-Za-z_0-9]*)(?:\:(?:[_A-Za-z]+[_A-Za-z_0-9]*))?))!)?(?:\$?[A-Za-z]+\$?[0-9]+)(?:\s*\:\s*(?:\$?[A-Za-z]+\$?[0-9]+))?/,
      token: "CELL"
    },
    {
