...
Generate time: Wed Nov 03 2021 18:30:08 GMT+0800 (中国标准时间)
*/
var $parser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ["s", ["k", "t", "l"]],
      ["q", ["t", "a"]],
      ["u", ["e", "v", 1, "u"], undefined, "w"],
      ["u", ["g", "v", 1, "u"], undefined, "w"],
      ["u", []],
      ["t", ["v", 1, "u"]],
      ["x", ["h", "y", 1, "x"], undefined, "w"],
      ["x", ["i", "y", 1, "x"], undefined, "w"],
      ["x", []],
      ["v", ["y", 1, "x"]],
      ["z", ["j", "y"]],
      ["z", []],
  ...
  lexer.symbolMap = {
    ...
    program: "n",
    statements: "o",
    "(zeroMore_statements_3_group_0_1)1_": "p",
    statements_3_group_0: "q",
    zeroMore_statements_3_group_0_1: "r",
    exp_p_end: "s",
    exp: "t",
    "(exp)1_": "u",
    exp_p_2: "v",
