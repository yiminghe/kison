...
Generate time: Thu Sep 30 2021 19:20:13 GMT+0800 (中国标准时间)
*/
var $parser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ['$START', ['exp']],
      ['exp', ['NUMBER', 'post*'], undefined, 'binary-exp'],
      ['post', ['+', 'NUMBER']],
    ],
    productionIndexMap: {
      symbol: 0,
  ...
  parser.lexer = lexer;
  parser.lex = lex;
  const productionSkipAstNodeSet = new Set([2]);
