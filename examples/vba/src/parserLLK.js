/*
Generated By kison v0.5.15

Generate time: Thu Oct 28 2021 19:32:35 GMT+0800 (中国标准时间)
*/
var vbaParser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ['block', ['blockStmt', 'block_19_group_1*', 'endOfStatement']],
      ['blockStmt', ['eraseStmt']],
      ['blockStmt', ['exitStmt']],
      ...
      ['blockStmt', ['letStmt']],
      ['blockStmt', ['redimStmt']],
      ['eraseStmt', ['ERASE', 'valueStmt', 'eraseStmt_28_group_2*']],
      [
        'redimStmt',
        ['REDIM', 'PRESERVE?', 'redimSubStmt', 'redimStmt_29_group_3*'],
      ],
      [
        'redimSubStmt',
        [
      ...
      [
        ...
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_MemberProcedureCall_43_group_5?',
          'eCS_MemberProcedureCall_43_group_10?',
        ],
      ],
      [
        'eCS_ProcedureCall',
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_ProcedureCall_44_group_3?',
          'eCS_ProcedureCall_44_group_8?',
        ],
      ],
      ...
      [
        ...
        [
          ...
          'argsCall?',
          'dictionaryCallStmt?',
          'iCS_B_MemberProcedureCall_47_group_6?',
        ],
      ],
      [
        'iCS_B_ProcedureCall',
        ['IDENTIFIER', 'argsCall?', 'iCS_B_ProcedureCall_48_group_2?'],
      ],
      ['argsCall', ['argsCall_49_group_0*', 'argCall', 'argsCall_49_group_7*']],
      ['argsCall', ['argsCall_50_group_0*', 'argCall', 'argsCall_50_group_7*']],
      ['argsCall', ['argsCall_51_group_0*', 'argCall', 'argsCall_51_group_7*']],
      ['argsCall', ['argsCall_52_group_0*', 'argCall', 'argsCall_52_group_7*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_60_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_61_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['subscripts', ['subscript_', 'subscripts_62_group_1*']],
      ['subscript_', ['subscript__63_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_64_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      [
        ...
        [
          ...
          'RPAREN',
          'dictionaryCallStmt?',
          'iCS_S_ProcedureOrArrayCall_76_group_6?',
        ],
      ],
      [
        'iCS_S_VariableOrProcedureCall',
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_77_group_3?',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__91_group_3?']],
      ['type_', ['complexType', 'type__92_group_3?']],
      ['complexType', ['IDENTIFIER', 'complexType_93_group_1*']],
      ['complexType', ['IDENTIFIER', 'complexType_94_group_1*']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_104_group_1?']],
      ...
      ['block_19_group_1', ['endOfStatement', 'blockStmt']],
      ['eraseStmt_28_group_2', [',', 'valueStmt']],
      ['redimStmt_29_group_3', [',', 'redimSubStmt']],
      ['eCS_MemberProcedureCall_43_group_5', ['LPAREN', 'argsCall', 'RPAREN']],
      [
        'eCS_MemberProcedureCall_43_group_10',
        ['LPAREN', 'subscripts', 'RPAREN'],
      ],
      ['eCS_ProcedureCall_44_group_3', ['LPAREN', 'argsCall', 'RPAREN']],
      ['eCS_ProcedureCall_44_group_8', ['LPAREN', 'subscripts', 'RPAREN']],
      [
        'iCS_B_MemberProcedureCall_47_group_6',
        ['LPAREN', 'subscripts', 'RPAREN'],
      ],
      ['iCS_B_ProcedureCall_48_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_49_group_0', ['argCall?', ',']],
      ['argsCall_49_group_7', [',', 'argCall?']],
      ['argsCall_50_group_0', ['argCall?', ',']],
      ['argsCall_50_group_7', [';', 'argCall?']],
      ['argsCall_51_group_0', ['argCall?', ';']],
      ['argsCall_51_group_7', [',', 'argCall?']],
      ['argsCall_52_group_0', ['argCall?', ';']],
      ['argsCall_52_group_7', [';', 'argCall?']],
      ['variableListStmt_60_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_61_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscripts_62_group_1', [',', 'subscript_']],
      ['subscript__63_group_0', ['valueStmt', 'TO']],
      ['argList_64_group_1', ['arg', 'argList_64_group_1_236_group_1*']],
      ['iCS_S_MembersCall_70_group_5', ['LPAREN', 'subscripts', 'RPAREN']],
      ['iCS_S_MembersCall_71_group_5', ['LPAREN', 'subscripts', 'RPAREN']],
      [
        'iCS_S_ProcedureOrArrayCall_76_group_6',
        ['LPAREN', 'subscripts', 'RPAREN'],
      ],
      ...
      ['arg_87_group_7', ['LPAREN', 'RPAREN']],
      ['arg_88_group_7', ['LPAREN', 'RPAREN']],
      ['type__91_group_3', ['LPAREN', 'RPAREN']],
      ['type__92_group_3', ['LPAREN', 'RPAREN']],
      ['complexType_93_group_1', ['.', 'IDENTIFIER']],
      ['complexType_94_group_1', ['!', 'IDENTIFIER']],
      ['baseType_104_group_1', ['MULT', 'valueStmt']],
      ['argList_64_group_1_236_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
