...
Generate time: Wed Jun 23 2021 15:01:22 GMT+0800 (中国标准时间)
*/
...
var parser = {
'productions': [['formula', ['expression']], ['expression', ['exp='], undefined, 'single-exp'], ['exp=_', ['=', 'exp<=', 1, 'exp=_']], ['exp=_', []], ['exp=', ['exp<=', 1, 'exp=_'], undefined, 'single-exp'], ['exp<=_', ['<=', 'exp<', 1, 'exp<=_']], ['exp<=_', ['>=', 'exp<', 1, 'exp<=_']], ['exp<=_', ['<>', 'exp<', 1, 'exp<=_']], ['exp<=_', ['||', 'exp<', 1, 'exp<=_']], ['exp<=_', []], ['exp<=', ['exp<', 1, 'exp<=_'], undefined, 'single-exp'], ['exp<_', ['<', 'exp+', 1, 'exp<_']], ['exp<_', ['>', 'exp+', 1, 'exp<_']], ['exp<_', []], ['exp<', ['exp+', 1, 'exp<_'], undefined, 'single-exp'], ['exp+_', ['+', 'exp*', 1, 'exp+_']], ['exp+_', ['-', 'exp*', 1, 'exp+_']], ['exp+_', []], ['exp+', ['exp*', 1, 'exp+_'], undefined, 'single-exp'], ['exp*_', ['*', 'exp^', 1, 'exp*_']], ['exp*_', ['/', 'exp^', 1, 'exp*_']], ['exp*_', []], ['exp*', ['exp^', 1, 'exp*_'], undefined, 'single-exp'], ['exp^_', ['^', 'exp&', 1, 'exp^_']], ['exp^_', []], ['exp^', ['exp&', 1, 'exp^_'], undefined, 'single-exp'], ['exp&_', ['&', 'exp%', 1, 'exp&_']], ['exp&_', []], ['exp&', ['exp%', 1, 'exp&_'], undefined, 'single-exp'], ['exp%_', ['%', 1, 'exp%_']], ['exp%_', []], ['exp%', ['prefix-exp', 1, 'exp%_'], undefined, 'single-exp'], ['prefix-exp', ['-', 'prefix-exp'], undefined, 'single-exp'], ['prefix-exp', ['+', 'prefix-exp'], undefined, 'single-exp'], ['prefix-exp', ['atom-exp'], undefined, 'single-exp'], ['atom-exp', ['(', 'exp=', ')'], undefined, 'single-exp'], ['atom-exp', ['NUMBER'], undefined, 'number-exp'], ['atom-exp', ['STRING'], undefined, 'string-exp'], ['atom-exp', ['LOGIC'], undefined, 'string-exp'], ['atom-exp', ['ERROR'], undefined, 'error-exp'], ['atom-exp', ['VARIABLE'], undefined, 'error-exp'], ['atom-exp', ['cell'], undefined, 'single-exp'], ['atom-exp', ['function'], undefined, 'single-exp'], ['atom-exp', ['array'], undefined, 'single-exp'], ['_function', ['arguments', ')']], ['_function', [')']], ['function', ['FUNCTION', '(', '_function']], ['array-element', ['STRING']], ['array-element', ['NUMBER']], ['array-element', ['LOGIC']], ['array-element', ['ERROR']], ['array-list_', ['ARRAY_SEPARATOR', 'array-element', 1, 'array-list_']], ['array-list_', []], ['array-list', ['array-element', 1, 'array-list_']], ['array', ['{', 'array-list', '}']], ['arguments_', ['ARGUMENT_SEPARATOR', 'exp=', 1, 'arguments_']], ['arguments_', []], ['arguments', ['exp=', 1, 'arguments_']], ['_cell', [':', 'CELL']], ['_cell', []], ['cell', ['CELL', '_cell']]]
,'productionIndexMap': {
'symbol': 0
,'rhs': 1
,'action': 2
...
parser.lexer = lexer;
const productionSkipEndSet = new Set([2,3,5,6,7,8,9,11,12,13,15,16,17,19,20,21,23,24,26,27,29,30,44,45,51,52,55,56,58,59]);
