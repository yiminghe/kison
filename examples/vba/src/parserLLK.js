...
Generate time: Thu Oct 21 2021 15:55:44 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_ProcedureCall_21_group_3?',
          'eCS_ProcedureCall_21_group_8*',
        ],
      ],
      ['implicitCallStmt_InBlock', ['iCS_B_ProcedureCall']],
      [
        'iCS_B_ProcedureCall',
        ['IDENTIFIER', 'argsCall?', 'iCS_B_ProcedureCall_23_group_2*'],
      ],
      ['argsCall', ['argsCall_24_group_0*', 'argCall', 'argsCall_24_group_7*']],
      ['argsCall', ['argsCall_25_group_0*', 'argCall', 'argsCall_25_group_7*']],
      ['argsCall', ['argsCall_26_group_0*', 'argCall', 'argsCall_26_group_7*']],
      ['argsCall', ['argsCall_27_group_0*', 'argCall', 'argsCall_27_group_7*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_35_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_36_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['subscripts', ['subscript_', 'subscripts_37_group_1*']],
      ['subscript_', ['subscript__38_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_39_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      [
        ...
        [
          ...
          'RPAREN',
          'dictionaryCallStmt?',
          'iCS_S_ProcedureOrArrayCall_44_group_6*',
        ],
      ],
      [
        ...
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_45_group_3*',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__59_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_69_group_1?']],
      ['fieldLength', ['MULT', 'INTEGERLITERAL']],
      ['fieldLength', ['MULT', 'IDENTIFIER']],
      ['eCS_ProcedureCall_21_group_3', ['LPAREN', 'argsCall', 'RPAREN']],
      ['eCS_ProcedureCall_21_group_8', ['LPAREN', 'subscripts', 'RPAREN']],
      ['iCS_B_ProcedureCall_23_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_24_group_0', ['argCall?', ',']],
      ['argsCall_24_group_7', [',', 'argCall?']],
      ['argsCall_25_group_0', ['argCall?', ',']],
      ['argsCall_25_group_7', [';', 'argCall?']],
      ['argsCall_26_group_0', ['argCall?', ';']],
      ['argsCall_26_group_7', [',', 'argCall?']],
      ['argsCall_27_group_0', ['argCall?', ';']],
      ['argsCall_27_group_7', [';', 'argCall?']],
      ['variableListStmt_35_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_36_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscripts_37_group_1', [',', 'subscript_']],
      ['subscript__38_group_0', ['valueStmt', 'TO']],
      ['argList_39_group_1', ['arg', 'argList_39_group_1_158_group_1*']],
      [
        'iCS_S_ProcedureOrArrayCall_44_group_6',
      ...
      ['arg_55_group_7', ['LPAREN', 'RPAREN']],
      ['arg_56_group_7', ['LPAREN', 'RPAREN']],
      ['type__59_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_69_group_1', ['MULT', 'valueStmt']],
      ['argList_39_group_1_158_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
