/*
Generated By kison v0.5.47

Generate time: Fri Mar 04 2022 18:49:50 GMT+0800 (中国标准时间)
*/
var formulaParser = (function (undefined) {
  ...
  var lexer = new Lexer({
    rules: [
      ...
      [
        'FUNCTION',
        /(?:(?:[A-Za-z\u00C0-\u02AF_][A-Za-z0-9\u00C0-\u02AF._]*)(?:\.(?:[A-Za-z\u00C0-\u02AF_][A-Za-z0-9\u00C0-\u02AF._]*))*)(?=[(])/g,
        function () {
          const { userData } = this;
          userData.markParen = userData.markParen || [];
      ...
      [
        'CELL',
        /(?:(?:(?:'(?:''|[^'])*')|(?:(?:[A-Za-z\u00C0-\u02AF_][A-Za-z0-9\u00C0-\u02AF._]*)(?:\:(?:[A-Za-z\u00C0-\u02AF_][A-Za-z0-9\u00C0-\u02AF._]*))?))!)?(?:(?:(?:\$?[A-Za-z]+\$?[0-9]+)(?:\s*\:\s*(?:\$?[A-Za-z]+\$?[0-9]+))?#?)|(?:\d+\:\d+))/g,
      ],
