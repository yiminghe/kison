...
Generate time: Wed Oct 27 2021 16:33:08 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'RPAREN',
          'dictionaryCallStmt?',
          'iCS_S_ProcedureOrArrayCall_65_group_6?',
        ],
      ],
      [
        ...
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_66_group_3?',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__80_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_90_group_1?']],
      ...
      ['argList_60_group_1', ['arg', 'argList_60_group_1_205_group_1*']],
      [
        'iCS_S_ProcedureOrArrayCall_65_group_6',
      ...
      ['arg_76_group_7', ['LPAREN', 'RPAREN']],
      ['arg_77_group_7', ['LPAREN', 'RPAREN']],
      ['type__80_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_90_group_1', ['MULT', 'valueStmt']],
      ['argList_60_group_1_205_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
