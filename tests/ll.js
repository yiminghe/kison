...
Generate time: Fri Nov 05 2021 20:42:45 GMT+0800 (中国标准时间)
*/
var $parser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ['program', ['statements']],
      [
        '(zeroMore_statements_3_group_0_1)1_',
        ['statements_3_group_0', '(zeroMore_statements_3_group_0_1)1_'],
      ],
      ['(zeroMore_statements_3_group_0_1)1_', []],
      [
        'zeroMore_statements_3_group_0_1',
        ['(zeroMore_statements_3_group_0_1)1_'],
      ],
      [
        'statements',
        ['statements_3_group_0', 'zeroMore_statements_3_group_0_1'],
      ],
      ['exp_p_end', ['NUMBER'], undefined, 'singleExp'],
      ['exp_p_end', ['(', 'exp', ')'], undefined, 'groupExp'],
      ['statements_3_group_0', ['exp', 'NEW_LINE']],
      ['(exp)1_', ['+', 'exp_p_2', 1, '(exp)1_'], undefined, 'binaryExp'],
      ['(exp)1_', ['-', 'exp_p_2', 1, '(exp)1_'], undefined, 'binaryExp'],
      ['(exp)1_', []],
      ['exp', ['exp_p_2', '(exp)1_'], undefined, undefined, undefined, true],
      [
        '(exp_p_2)1_',
