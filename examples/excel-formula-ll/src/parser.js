...
Generate time: Fri Sep 03 2021 18:26:58 GMT+0800 (中国标准时间)
*/
var parser = (function(undefined) {
  ...
  var lexer = new Lexer({
    rules: [
      ...
      [
        "CELL",
        /^(?:(?:(?:'(?:''|[^'])*')|(?:(?:[_A-Za-z一-龥]+[_A-Za-z_0-9一-龥]*)(?:\:(?:[_A-Za-z一-龥]+[_A-Za-z_0-9一-龥]*))?))!)?(?:(?:(?:\$?[A-Za-z]+\$?[0-9]+)(?:\s*\:\s*(?:\$?[A-Za-z]+\$?[0-9]+))?#?)|(?:\d+\:\d+))/
      ],
  ...
  var parser = {
    productions: [
      ...
      ["reference", ["union-reference"], undefined, "reference"],
      [
        "(union-reference)1_",
      ...
      [
        "union-reference",
        ["intersect-reference", 1, "(union-reference)1_"],
        undefined,
        "reference"
      ],
      [
      ...
      [
        "expand-reference",
        ["reference-item", 1, "(expand-reference)1_"],
        undefined,
        "reference"
      ],
