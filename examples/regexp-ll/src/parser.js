...
/*
Generated By kison v0.4.18

Generate time: Mon Aug 09 2021 18:04:12 GMT+0800 (中国标准时间)
*/
  ...
  matchGroupName: function(input, prefix) {
...
var parser = {
  productions: [
    ...
    ["(CharacterGroupInner)1_", []],
    ["CharacterGroupInner", ["CharacterGroupItem", "(CharacterGroupInner)1_"]],
...
parser.table = {
  ...
  Expression: {
    ...
    whitespaceCharacter: 4,
    whitespaceCharacterInverted: 4,
    char: 4,
    "(": 4,
    namedGroupPrefix: 4,
  ...
  "_2(Group)": {
    ...
    whitespaceCharacter: 13,
    whitespaceCharacterInverted: 13,
    char: 13,
    "(": 13,
    namedGroupPrefix: 13,
  ...
  CharacterGroupInner: {
    ...
    whitespaceCharacter: 35,
    whitespaceCharacterInverted: 35,
    char: 35
  },
  CharacterGroupItem: {
  ...
  CharacterClass: {
    ...
    whitespaceCharacter: 42,
    whitespaceCharacterInverted: 43
  },
  "_1(CharacterRange)": {
    "-": 44,
    ...
    whitespaceCharacter: 45,
    whitespaceCharacterInverted: 45,
    char: 45,
    "]": 45
  },
  CharacterRange: {
  ...
  "_1(Quantifier)": {
    anyChar: 47,
    "[": 47,
    characterClassAnyWordInverted: 47,
    characterClassAnyWord: 47,
    characterClassAnyDecimalDigit: 47,
    characterClassAnyDecimalDigitInverted: 47,
    whitespaceCharacter: 47,
    whitespaceCharacterInverted: 47,
    char: 47,
    "(": 47,
    namedGroupPrefix: 47,
    anchorWordBoundary: 47,
    anchorNonWordBoundary: 47,
    anchorStartOfStringOnly: 47,
    anchorEndOfStringOnlyNotNewline: 47,
    anchorEndOfStringOnly: 47,
    anchorPreviousMatchEnd: 47,
    $: 47,
    lookahead: 47,
    negativeLookahead: 47,
    lookbehind: 47,
    negativeLookbehind: 47,
    backreference: 47,
    "|": 47,
    $EOF: 47,
    ")": 47,
  ...
  Anchor: {
    anchorWordBoundary: 58,
    anchorNonWordBoundary: 59,
    anchorStartOfStringOnly: 60,
    anchorEndOfStringOnlyNotNewline: 61,
    anchorEndOfStringOnly: 62,
    anchorPreviousMatchEnd: 63,
    $: 64,
    lookahead: 65,
    negativeLookahead: 66,
    lookbehind: 67,
    negativeLookbehind: 68
  }
};
