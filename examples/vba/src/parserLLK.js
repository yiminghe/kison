...
Generate time: Wed Oct 20 2021 16:51:36 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_43_group_3*',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__57_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_67_group_1?']],
      ...
      ['argList_39_group_1', ['arg', 'argList_39_group_1_154_group_1*']],
      [
        'iCS_S_VariableOrProcedureCall_43_group_3',
        ['LPAREN', 'subscripts', 'RPAREN'],
      ],
      ['arg_53_group_7', ['LPAREN', 'RPAREN']],
      ['arg_54_group_7', ['LPAREN', 'RPAREN']],
      ['type__57_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_67_group_1', ['MULT', 'valueStmt']],
      ['argList_39_group_1_154_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
