...
Generate time: Fri Oct 22 2021 15:19:16 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_ProcedureCall_27_group_3?',
          'eCS_ProcedureCall_27_group_8?',
        ],
      ],
      ['implicitCallStmt_InBlock', ['iCS_B_ProcedureCall']],
      [
        'iCS_B_ProcedureCall',
        ['IDENTIFIER', 'argsCall?', 'iCS_B_ProcedureCall_29_group_2?'],
      ],
      ['argsCall', ['argsCall_30_group_0*', 'argCall', 'argsCall_30_group_7*']],
      ['argsCall', ['argsCall_31_group_0*', 'argCall', 'argsCall_31_group_7*']],
      ['argsCall', ['argsCall_32_group_0*', 'argCall', 'argsCall_32_group_7*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_41_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_42_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['subscripts', ['subscript_', 'subscripts_43_group_1*']],
      ['subscript_', ['subscript__44_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_45_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      [
        ...
        [
          ...
          'RPAREN',
          'dictionaryCallStmt?',
          'iCS_S_ProcedureOrArrayCall_50_group_6?',
        ],
      ],
      [
        ...
        [
          ...
          'typeHint?',
          'dictionaryCallStmt?',
          'iCS_S_VariableOrProcedureCall_51_group_3?',
        ],
      ],
      ['dictionaryCallStmt', ['!', 'IDENTIFIER', 'typeHint?']],
      ...
      ['type_', ['baseType', 'type__65_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_75_group_1?']],
      ['fieldLength', ['MULT', 'INTEGERLITERAL']],
      ['fieldLength', ['MULT', 'IDENTIFIER']],
      ['eCS_ProcedureCall_27_group_3', ['LPAREN', 'argsCall', 'RPAREN']],
      ['eCS_ProcedureCall_27_group_8', ['LPAREN', 'subscripts', 'RPAREN']],
      ['iCS_B_ProcedureCall_29_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_30_group_0', ['argCall?', ',']],
      ['argsCall_30_group_7', [',', 'argCall?']],
      ['argsCall_31_group_0', ['argCall?', ',']],
      ['argsCall_31_group_7', [';', 'argCall?']],
      ['argsCall_32_group_0', ['argCall?', ';']],
      ['argsCall_32_group_7', [',', 'argCall?']],
      ['argsCall_33_group_0', ['argCall?', ';']],
      ['argsCall_33_group_7', [';', 'argCall?']],
      ['variableListStmt_41_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_42_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscripts_43_group_1', [',', 'subscript_']],
      ['subscript__44_group_0', ['valueStmt', 'TO']],
      ['argList_45_group_1', ['arg', 'argList_45_group_1_170_group_1*']],
      [
        'iCS_S_ProcedureOrArrayCall_50_group_6',
      ...
      ['arg_61_group_7', ['LPAREN', 'RPAREN']],
      ['arg_62_group_7', ['LPAREN', 'RPAREN']],
      ['type__65_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_75_group_1', ['MULT', 'valueStmt']],
      ['argList_45_group_1_170_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
