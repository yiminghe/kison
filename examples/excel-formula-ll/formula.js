/*
Generated By kison v0.4.0-alpha.15

Build time: Fri Jun 18 2021 12:55:37 GMT+0800 (中国标准时间)
*/
var formula = (function(undefined) {
  ...
  parser.productions = [
    ...
    ["exp=_", ["=", "exp<=", 1, "exp=_"]],
    ["exp=_", []],
    ["exp=", ["exp<=", 1, "exp=_"], 0, "single-exp"],
    ["exp<=_", ["<=", "exp<", 1, "exp<=_"]],
    ["exp<=_", [">=", "exp<", 1, "exp<=_"]],
    ["exp<=_", ["<>", "exp<", 1, "exp<=_"]],
    ["exp<=_", ["NOT", "exp<", 1, "exp<=_"]],
    ["exp<=_", ["||", "exp<", 1, "exp<=_"]],
    ["exp<=_", []],
    ["exp<=", ["exp<", 1, "exp<=_"], 0, "single-exp"],
    ["exp<_", ["<", "exp+", 1, "exp<_"]],
    ...
    ["exp%_", ["%", 1, "exp%_"]],
    ["exp%_", []],
    ["exp%", ["prefix-exp", 1, "exp%_"], 0, "single-exp"],
