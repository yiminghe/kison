...
Generate time: Wed Nov 23 2022 11:32:01 GMT+0800 (中国标准时间)
*/
var bashParser = (function (undefined) {
    ...
    rules: [
      [
        ...
        function () {
          ...
          if (
            (_a = stringTag[stringTag.length - 1]) == null
              ? void 0
              : _a.inString
          ) {
            stringTag.pop();
  ...
  var parser = {
    productions: [
      ['$START', ['progam']],
      ['progam_group_def_2', ['LINE_END', 'command']],
      ['progam', ['LINE_END?', 'command', 'progam_group_def_2*', 'LINE_END?']],
      ['command_group_def_4', ['literal']],
      ['command', ['command_group_def_4', 'command_group_def_4*']],
      ['literal', ['WORD']],
      ['literal', ['string']],
      ['literal', ['RAW_STRING']],
      ['literal', ['ANSII_C_STRING']],
      ['string_group_def_6', ['DOLLAR?', 'STRING_CONTENT']],
      ['string', ['QUOTE', 'string_group_def_6*', 'QUOTE']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
  ...
  productionSkipAstNodeSet = new Set([1, 3, 9]);
