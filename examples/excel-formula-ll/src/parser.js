...
Generate time: Thu Sep 16 2021 18:30:58 GMT+0800 (中国标准时间)
*/
var formulaParser = (function(undefined) {
  ...
  var parser = {
    productions: [
      ['formula', ['binary-equal-exp']],
      [
        '(binary-equal-exp)1_',
        ['=', 'binary-concat-exp', 1, '(binary-equal-exp)1_'],
      ],
      [
        '(binary-equal-exp)1_',
        ['<=', 'binary-concat-exp', 1, '(binary-equal-exp)1_'],
      ...
      ['(binary-equal-exp)1_', []],
      ['binary-equal-exp', ['binary-concat-exp', 1, '(binary-equal-exp)1_']],
      [
        '(binary-concat-exp)1_',
        ['&', 'binary-add-exp', 1, '(binary-concat-exp)1_'],
      ],
      ['(binary-concat-exp)1_', []],
      ['binary-concat-exp', ['binary-add-exp', 1, '(binary-concat-exp)1_']],
      ['(binary-add-exp)1_', ['+', 'binary-mul-exp', 1, '(binary-add-exp)1_']],
      ['(binary-add-exp)1_', ['-', 'binary-mul-exp', 1, '(binary-add-exp)1_']],
      ['(binary-add-exp)1_', []],
      ['binary-add-exp', ['binary-mul-exp', 1, '(binary-add-exp)1_']],
      ['(binary-mul-exp)1_', ['*', 'binary-expo-exp', 1, '(binary-mul-exp)1_']],
      ['(binary-mul-exp)1_', ['/', 'binary-expo-exp', 1, '(binary-mul-exp)1_']],
      ['(binary-mul-exp)1_', []],
      ['binary-mul-exp', ['binary-expo-exp', 1, '(binary-mul-exp)1_']],
      [
        '(binary-expo-exp)1_',
        ['^', 'unary-percent-exp', 1, '(binary-expo-exp)1_'],
      ],
      ['(binary-expo-exp)1_', []],
      ['binary-expo-exp', ['unary-percent-exp', 1, '(binary-expo-exp)1_']],
      ['(unary-percent-exp)1_', ['%', 1, '(unary-percent-exp)1_']],
      ['(unary-percent-exp)1_', []],
      ['unary-percent-exp', ['unary-add-exp', 1, '(unary-percent-exp)1_']],
      ['unary-add-exp', ['unary-clip-exp']],
      ['unary-add-exp', ['+', 'unary-add-exp']],
      ['unary-add-exp', ['-', 'unary-add-exp']],
      ['unary-clip-exp', ['atom-exp']],
      ['unary-clip-exp', ['@', 'unary-clip-exp']],
      ['atom-exp', ['(', 'binary-equal-exp', ')']],
      ['atom-exp', ['NUMBER']],
      ['atom-exp', ['STRING']],
      ['atom-exp', ['LOGIC']],
      ['atom-exp', ['ERROR']],
  ...
  parser.table = {
    ...
    'intersect-reference': {
      ...
      NAME: 48,
      TABLE_NAME: 48,
      TABLE_ITEM_SPECIFIER: 48,
      '[': 48,
    },
    '(expand-reference)1_': {
      REF_EXPAND_OPERATOR: 49,
      CELL: 50,
      NAME: 50,
      TABLE_NAME: 50,
      TABLE_ITEM_SPECIFIER: 50,
      '[': 50,
      REF_UNION_OPERATOR: 50,
      '%': 50,
      '^': 50,
      '*': 50,
      '/': 50,
    ...
    'table-specifier': {
      TABLE_ITEM_SPECIFIER: 68,
      '[': 69,
    },
    '_1(table-this-row)': {
      TABLE_COLUMN_SPECIFIER: 70,
      ']': 71,
    },
    'table-this-row': {
      'TABLE_@': 72,
    ...
    'table-specifier-item': {
      TABLE_COLUMN_SPECIFIER: 75,
      TABLE_ITEM_SPECIFIER: 76,
    },
    '(table-column-specifier)1_': {
      SPECIFIER_SEPARATOR: 77,
      ']': 78,
    },
    'table-column-specifier': {
      TABLE_COLUMN_SPECIFIER: 79,
