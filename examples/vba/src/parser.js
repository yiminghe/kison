...
Generate time: Tue Nov 23 2021 12:25:34 GMT+0800 (中国标准时间)
*/
var vbaParser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ['argCall_group_def_29', ['BYREF']],
      ['argCall_group_28', ['argCall_group_def_29']],
      ['argCall_group_def_30', ['BYVAL']],
      ['argCall_group_28', ['argCall_group_def_30']],
      ['argCall_group_def_31', ['PARAMARRAY']],
      ['argCall_group_28', ['argCall_group_def_31']],
      ['argCall', ['LPAREN?', 'argCall_group_28?', 'RPAREN?', 'valueStmt']],
      ['variableStmt_group_def_33', ['DIM']],
      ['variableStmt_group_32', ['variableStmt_group_def_33']],
      ['variableStmt_group_def_34', ['STATIC']],
      ['variableStmt_group_32', ['variableStmt_group_def_34']],
      ['variableStmt_group_def_35', ['visibility']],
      ['variableStmt_group_32', ['variableStmt_group_def_35']],
      [
        'variableStmt',
        ['variableStmt_group_32', 'WITHEVENTS?', 'variableListStmt'],
      ],
      ['variableListStmt_group_def_37', [',', 'variableSubStmt']],
      [
        'variableListStmt',
        ['variableSubStmt', 'variableListStmt_group_def_37*'],
      ],
      ['variableSubStmt_group_def_39', ['LPAREN', 'subscripts?', 'RPAREN']],
      [
        'variableSubStmt',
        [
          'ambiguousIdentifier',
          'variableSubStmt_group_def_39?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['indexes', ['valueStmt', 'eraseStmt_group_def_11*']],
      ['subscript__group_def_42', ['valueStmt', 'TO']],
      ['subscript_', ['subscript__group_def_42?', 'valueStmt']],
      ['subscripts_group_def_44', [',', 'subscript_']],
      ['subscripts', ['subscript_', 'subscripts_group_def_44*']],
      ['subscript_', ['subscript__group_def_42?', 'valueStmt']],
      ['argList_group_def_48', [',', 'arg']],
      ['argList_group_def_49', ['arg', 'argList_group_def_48*']],
      ['argList', ['LPAREN', 'argList_group_def_49?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ...
      ['iCS_S_MembersCall_group_def_51', ['iCS_S_VariableOrProcedureCall']],
      ['iCS_S_MembersCall_group_50', ['iCS_S_MembersCall_group_def_51']],
      ['iCS_S_MembersCall_group_def_52', ['iCS_S_ProcedureOrArrayCall']],
      ['iCS_S_MembersCall_group_50', ['iCS_S_MembersCall_group_def_52']],
      [
        'iCS_S_MembersCall',
        [
          'iCS_S_MembersCall_group_50?',
          'iCS_S_MemberCall',
          'iCS_S_MemberCall*',
          'dictionaryCallStmt?',
          'eCS_MemberProcedureCall_group_def_21*',
      ...
      ['iCS_S_MemberCall_group_54', ['iCS_S_MemberCall_group_def_55']],
      ['iCS_S_MemberCall_group_def_56', ['!']],
      ['iCS_S_MemberCall_group_54', ['iCS_S_MemberCall_group_def_56']],
      ['iCS_S_MemberCall_group_57', ['iCS_S_MembersCall_group_def_51']],
      ['iCS_S_MemberCall_group_57', ['iCS_S_MembersCall_group_def_52']],
      [
        'iCS_S_MemberCall',
        ['iCS_S_MemberCall_group_54', 'iCS_S_MemberCall_group_57'],
      ],
      [
      ...
      ['typeHint', ['@']],
      ['typeHint', ['$']],
      ['arg_group_60', ['argCall_group_def_30']],
      ['arg_group_60', ['argCall_group_def_29']],
      ['arg_group_def_62', ['LPAREN', 'RPAREN']],
      [
        'arg',
        [
          'OPTIONAL?',
      ...
      ['type__group_def_64', ['baseType']],
      ['type__group_63', ['type__group_def_64']],
      ['type__group_def_65', ['complexType']],
      ['type__group_63', ['type__group_def_65']],
      ['type_', ['type__group_63', 'arg_group_def_62?']],
      ['complexType_group_68', ['iCS_S_MemberCall_group_def_55']],
      ['complexType_group_68', ['iCS_S_MemberCall_group_def_56']],
      [
        'complexType_group_def_69',
        ['complexType_group_68', 'ambiguousIdentifier'],
      ],
      ['complexType', ['ambiguousIdentifier', 'complexType_group_def_69*']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['DOUBLE']],
      ['baseType', ['INTEGER']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType_group_def_71', ['MULT', 'valueStmt']],
      ['baseType', ['STRING', 'baseType_group_def_71?']],
  ...
  productionSkipAstNodeSet = new Set([
    5, 6, 7, 8, 10, 19, 35, 45, 47, 56, 57, 58, 59, 60, 61, 66, 67, 74, 76, 77,
    78, 79, 80, 81, 83, 84, 85, 86, 87, 88, 90, 92, 95, 97, 100, 101, 109, 110,
    111, 112, 114, 115, 116, 117, 118, 119, 136, 137, 138, 142, 143, 144, 145,
    147, 148, 149, 158,
  ]);
