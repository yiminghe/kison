/*
Generated By kison v0.5.12

Generate time: Tue Oct 19 2021 19:26:28 GMT+0800 (中国标准时间)
*/
var vbaParser = (function (undefined) {
  ...
  var parser = {
    productions: [
      ...
      ["type_", ["baseType", "type__45_group_1?"]],
      ["baseType", ["BOOLEAN"]],
      ["baseType", ["BYTE"]],
      ["baseType", ["COLLECTION"]],
      ["baseType", ["DATE"]],
      ...
      ["baseType", ["SINGLE"]],
      ["baseType", ["VARIANT"]],
      ["baseType", ["STRING", "baseType_55_group_1?"]],
      ...
      ["argList_28_group_1", ["arg", "argList_28_group_1_128_group_1*"]],
      ["arg_41_group_7", ["LPAREN", "RPAREN"]],
      ["arg_42_group_7", ["LPAREN", "RPAREN"]],
      ["type__45_group_1", ["LPAREN", "RPAREN"]],
      ["baseType_55_group_1", ["MULT", "valueStmt"]],
      ["argList_28_group_1_128_group_1", [",", "arg"]],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
