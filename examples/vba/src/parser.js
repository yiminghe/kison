/*
Generated By kison v0.6.0

Generate time: Sat Dec 31 2022 03:03:21 GMT+0800 (中国标准时间)
*/
var vbaParser = (function (undefined) {
  ...
  var AstSymbolNode = class AstSymbolNode extends BaseAstNode {
    ...
    ruleIndex = -1;
    internalRuleIndex = -1;
    maxExaminedPos = -1; //rid=Math.random();
  ...
  var hasMemoizedResult = function (match, ruleIndex) {
    var col = match.memoTable[match.pos];
    return col && col.memo.has(ruleIndex);
  };
  var memoizeResult = function (match, pos, ruleIndex, ast) {
  ...
  var useMemoizedResult = function (match, ruleIndex) {
    var col = match.memoTable[match.pos];
  ...
  var applyEdit = function (match, startPos, endPos, rLength) {
  ...
  var parse = function (input, options = {}) {
    ...
    return {
      ...
      applyEdit(start, end, len) {
        applyEdit(matcher, start, end, len);
        return {
          memoTable: matcher.memoTable,
        };
      },
