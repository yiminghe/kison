...
Generate time: Wed Oct 20 2021 12:24:41 GMT+0800 (中国标准时间)
*/
    ...
    productions: [
      ...
      [
        ...
        [
          ...
          'IDENTIFIER',
          'typeHint?',
          'eCS_ProcedureCall_15_group_3?',
          'eCS_ProcedureCall_15_group_8*',
        ],
      ],
      ['implicitCallStmt_InBlock', ['iCS_B_ProcedureCall']],
      [
        'iCS_B_ProcedureCall',
        ['IDENTIFIER', 'argsCall?', 'iCS_B_ProcedureCall_17_group_2*'],
      ],
      ['argsCall', ['argsCall_18_group_0*', 'argCall', 'argsCall_18_group_7*']],
      ['argsCall', ['argsCall_19_group_0*', 'argCall', 'argsCall_19_group_7*']],
      ['argsCall', ['argsCall_20_group_0*', 'argCall', 'argsCall_20_group_7*']],
      ['argsCall', ['argsCall_21_group_0*', 'argCall', 'argsCall_21_group_7*']],
      ...
      ['variableListStmt', ['variableSubStmt', 'variableListStmt_27_group_1*']],
      [
        'variableSubStmt',
        [
          'IDENTIFIER',
          'variableSubStmt_28_group_1?',
          'typeHint?',
          'asTypeClause?',
        ],
      ],
      ['subscripts', ['subscript_', 'subscripts_29_group_1*']],
      ['subscript_', ['subscript__30_group_0?', 'valueStmt']],
      ['argList', ['LPAREN', 'argList_31_group_1?', 'RPAREN']],
      ['valueStmt', ['literal']],
      ['valueStmt', ['implicitCallStmt_InStmt']],
      ['implicitCallStmt_InStmt', ['iCS_S_VariableOrProcedureCall']],
      ['iCS_S_VariableOrProcedureCall', ['IDENTIFIER']],
      ...
      ['type_', ['baseType', 'type__48_group_1?']],
      ['baseType', ['BOOLEAN']],
      ['baseType', ['BYTE']],
      ['baseType', ['COLLECTION']],
      ['baseType', ['DATE']],
      ...
      ['baseType', ['SINGLE']],
      ['baseType', ['VARIANT']],
      ['baseType', ['STRING', 'baseType_58_group_1?']],
      ['fieldLength', ['MULT', 'INTEGERLITERAL']],
      ['fieldLength', ['MULT', 'IDENTIFIER']],
      ['eCS_ProcedureCall_15_group_3', ['LPAREN', 'argsCall', 'RPAREN']],
      ['eCS_ProcedureCall_15_group_8', ['LPAREN', 'subscripts', 'RPAREN']],
      ['iCS_B_ProcedureCall_17_group_2', ['LPAREN', 'subscripts', 'RPAREN']],
      ['argsCall_18_group_0', ['argCall?', ',']],
      ['argsCall_18_group_7', [',', 'argCall?']],
      ['argsCall_19_group_0', ['argCall?', ',']],
      ['argsCall_19_group_7', [';', 'argCall?']],
      ['argsCall_20_group_0', ['argCall?', ';']],
      ['argsCall_20_group_7', [',', 'argCall?']],
      ['argsCall_21_group_0', ['argCall?', ';']],
      ['argsCall_21_group_7', [';', 'argCall?']],
      ['variableListStmt_27_group_1', [',', 'variableSubStmt']],
      ['variableSubStmt_28_group_1', ['LPAREN', 'subscripts?', 'RPAREN']],
      ['subscripts_29_group_1', [',', 'subscript_']],
      ['subscript__30_group_0', ['valueStmt', 'TO']],
      ['argList_31_group_1', ['arg', 'argList_31_group_1_136_group_1*']],
      ['arg_44_group_7', ['LPAREN', 'RPAREN']],
      ['arg_45_group_7', ['LPAREN', 'RPAREN']],
      ['type__48_group_1', ['LPAREN', 'RPAREN']],
      ['baseType_58_group_1', ['MULT', 'valueStmt']],
      ['argList_31_group_1_136_group_1', [',', 'arg']],
    ],
    productionIndexMap: {
      symbol: 0,
      rhs: 1,
